...
#define MD_BT1_NAME "EPOMAKER TIDE 49 1"
#define MD_BT2_NAME "EPOMAKER TIDE 49 2"
#define MD_BT3_NAME "EPOMAKER TIDE 49 3"
#define MD_DONGLE_MANUFACTURER "EPOMAKER TIDE 49"
